...
{
    public class EnterpriseDetailsDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        private readonly IEnterpriseDetailRepository _enterpriseDetailRepository;

        public EnterpriseDetailsDataSeedContributor(IEnterpriseDetailRepository enterpriseDetailRepository)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("98cef5d2-574e-429e-92f1-c317905b39f6"),
            ...
            await _enterpriseDetailRepository.InsertAsync(new EnterpriseDetail
            (
                id: Guid.Parse("d171d866-5730-4bcc-ae88-e40661c6710c"),
