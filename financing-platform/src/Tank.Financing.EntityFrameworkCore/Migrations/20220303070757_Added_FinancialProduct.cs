    ...
    public partial class Added_FinancialProduct : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    AvailableDistricts = table.Column<int>(type: "int", nullable: false),
                    TimeLimit = table.Column<int>(type: "int", maxLength: 3600, nullable: false),
                    GuaranteeMethod = table.Column<int>(type: "int", nullable: false),
                    CreditCeiling = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Organization = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AppliedNumber = table.Column<int>(type: "int", nullable: true),
                    APR = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
