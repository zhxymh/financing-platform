...
(function(){
  ...
  (function(){
    ...
    volo.abp.account.accountSettings.getLdap = function(ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account-admin/settings/ldap',
        type: 'GET'
      }, ajaxParams));
    };

    volo.abp.account.accountSettings.updateLdap = function(input, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account-admin/settings/ldap',
        type: 'PUT',
        dataType: null,
